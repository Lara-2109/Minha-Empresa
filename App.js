...
function Sobre() {
  return(
    <View style={styles.section}>
      ...
      <Text>Fundada em 2025, temos o compromisso de trazer mais segurança e inovação para o mercado de jogos online.</Text>
    </View>
   );
}
...
function Serviços() {
  ...
  <View style={styles.section}>
      ...
      <Text>-Desenvolvimento de Personagens</Text>
      <Text>-Organização de Campeonatos</Text>
    </View>
   );
}
